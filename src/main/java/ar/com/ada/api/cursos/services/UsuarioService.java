...
import ar.com.ada.api.cursos.sistema.com.EmailService;
...
public class UsuarioService {
    ...
    public Usuario crearUsuario(TipoUsuarioEnum tipoUsuario, String nombre, int pais, TipoDocuEnum tipoDocumento,
        ...
        // Resgistrar la entidad que representa
        ...
        emailService.SendEmail(usuario.getEmail(), "Curso Pinturillo: Registro Exitoso", "Hola " + usuario.getUsername()+ ", bienvenid@ al sistema de cursos");
        return usuario;
    }
